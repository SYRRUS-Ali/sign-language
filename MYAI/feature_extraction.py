...
def extract_face_result(face_results):
    ...
    :return: features
    """
    # If there are no faces, return the array with the value 0
    if not face_results.multi_face_landmarks:
        return np.zeros(2)  # Or can return array with appropriate length

    # If there is a face, process as usual
    ...
    # Calculate the average value of the coordinates (can be changed depending on your requirements)
